...
<i>ABC</i> is trying to go paperless therefore we have stopped ID Card.<br><br>

In any future <i>ABC</i> event or tour, you will only require the membership ID.<br><br>

Again, we welcome you as a members of <i>ABC</i> family.<br><br>

By joining <i>ABC</i> you have become part of a large of Spanish Senior's Organization. <br><br>
...
Once again, welcome to <i>ABC</i>. We look forward to seeing you at our events.
...
SPANISH SENIORS ORGANIZATION OF TEXAS
...
<td>
{{ $member->spouse_first_name }} {{ $member->spouse_last_name }} - &nbsp; &nbsp; {{ $member->member_no }}
</td>
