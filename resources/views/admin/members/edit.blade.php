                ...
                <div class="tab-pane fade show active" id="personal" role="tabpanel">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="member_no" class="form-control" data-uppercase required value="{{ $member->member_no }}">
                            @error('member_no')
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="mb-2">
                                <img src="{{ asset('storage/' . $member->photo_path) }}" alt="Photo" class="rounded" width="100">
                            </div>
                            @endif
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="first_name" class="form-control" data-uppercase required value="{{ $member->first_name }}">
                            @error('first_name')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="last_name" class="form-control" data-uppercase required value="{{ $member->last_name }}">
                            @error('last_name')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date" name="dateofbirth" class="form-control" value="{{ $member->dateofbirth?->format('Y-m-d') }}">
                        </div>
                        <div class="col-md-6 mb-3">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date"
                                ...
                                class="form-control"
                                value="{{ old('spouse_dateofbirth', optional($spouseMember?->dateofbirth)->format('Y-m-d')) }}">
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="membership_type_id" class="form-select" required>
                                ...
                                <option value="{{ $type->id }}" {{ $member->membership_type_id == $type->id ? 'selected' : '' }}>
                        ...
                        <div class="col-md-6 mb-3" id="status-reason-div">
                            ...
                            <select name="status_reason" class="form-select">
                                ...
                                <option value="Out Of Town" {{ $member->status_reason == 'Out Of Town' ? 'selected' : '' }}>Out Of Town</option>
                                <option value="Passed Away" {{ $member->status_reason == 'Passed Away' ? 'selected' : '' }}>Passed Away</option>
                                <option value="Cancelled" {{ $member->status_reason == 'Cancelled' ? 'selected' : '' }}>Cancelled</option>
                            </select>
                        </div>

                        <div class="col-md-6 mb-3">
                            <label class="form-label">Membership Start Date</label>
                            <input type="date" name="membership_start_date" class="form-control" value="{{ $member->membership_start_date?->format('Y-m-d') }}">
                        </div>

                        <div class="col-md-6 mb-3">
                            <label class="form-label">Receipt No</label>
                            <input type="text" name="receipt_no" class="form-control" value="{{ $member->receipt_no }}">
                        </div>
                    </div>
                </div>
                ...
                <div class="tab-pane fade" id="contact" role="tabpanel">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="cell_phone" class="form-control" value="{{ $member->cell_phone }}">
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="address1" class="form-control" value="{{ $member->address1 }}">
                        </div>

                        <div class="col-md-6 mb-3">
                            <label class="form-label">Address 2</label>
                            <input type="text" name="address2" class="form-control" value="{{ $member->address2 }}">
                        </div>
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="text" name="state" class="form-control" value="{{ $member->state }}">
                        </div>

                        <div class="col-md-3 mb-3">
                            <label class="form-label">Zip</label>
                            <input type="text" name="zip" class="form-control" value="{{ $member->zip }}">
                        </div>

                        <div class="col-md-3 mb-3">
                            <label class="form-label">County</label>
                            <input type="text" name="county" class="form-control" value="{{ $member->county }}">
                        </div>
                    </div>
                </div>
            </div>
